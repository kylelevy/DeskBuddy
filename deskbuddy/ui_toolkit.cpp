...
void notificationIcon(const String &name, int16_t x, int16_t y) {
  ...
  if (name == "clock") { canvas->drawCircle(x + 6, y + 6, 6, SSD1306_WHITE); canvas->drawLine(x + 6, y + 6, x + 6, y + 2, SSD1306_BLACK); canvas->drawLine(x + 6, y + 6, x + 10, y + 8, SSD1306_BLACK); return; }
