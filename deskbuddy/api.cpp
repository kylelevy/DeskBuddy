...
void handleStatus() {
  ...
  out += ",\"summary\":\"" + DeskBuddyWeather::summary() + "\",\"error\":\"" + DeskBuddyWeather::error() + "\"},\"clock\":{\"utc_offset_minutes\":" + String(DeskBuddyClock::utcOffsetMinutes()) + "}}";
  reply(out);
}
